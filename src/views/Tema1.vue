<template lang="pug">
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .row.fondo1.p-4.p-lg-4.p-md-3.mb-5(data-aos="fade-down")
        .col-lg-11
              ...
              LineaTiempoE.color-primario.fnd1.ps-0
                .row.justify-content-center.align-items-center.text-white.tt(titulo="5300 años a.C" subtitulo="")
                  .col-lg-3.col-md-3.col-6.mb-3
                    img(src='@/assets/curso/tema1/i1.svg', alt='Texto que describa la imagen')
                  .col-lg-9.mb-3
                ...
                .row.justify-content-center.align-items-center.text-white.tt(titulo="1700 años a.C." subtitulo="")
                  .col-lg-3.col-md-3.col-6.mb-3
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12

          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-5.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/2.png', alt='Representa el proceso de colocación y ajuste de una prenda de ropa interior primitiva llamada subúcula.')
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12
          ...
          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-5.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/3.png', alt='Los gladiadores utilizaban una prenda llamada subligaculum, similar a un pañal, que cubría y protegía los genitales durante los combates.')
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-10.col-md-9
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12
          ...
          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-5.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/5.png', alt='Las mujeres casadas usaban el apodesmo, una faja de tejido fino con cintas de colores para realzar el busto, y el mastodeton, una banda diseñada para aplanarlo.')
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-10.col-md-9
          figcaption.mb-5 Fuente: SENA
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12
          ...
          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-5.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/6.png', alt='Los camisones eran prendas utilizados por mujeres y hombres, fabricados en finas telas.')
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-10.col-md-9
          figcaption.mb-5 Fuente: SENA
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-right").mb-5
        .col-lg-12
          .bloque-texto-g.mk.color-secundario.p-3.p-sm-4.p-md-5
            .bloque-texto-g__img(
              :style="{'background-image': `url(${require('@/assets/curso/tema1/i4.png')})`}", alt='Imagen decorativa.'
            )
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12
          ...
          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-5.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/8.png', alt='Corsé antiguo, una prenda ajustada con varillas y cordones diseñada para moldear la cintura y realzar la figura femenina. Su estructura rígida reflejaba los ideales de belleza de la época, aunque su uso prolongado podía causar problemas de salud.')
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-10.col-md-9
          figcaption.mb-5 Fuente: SENA
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12
          ...
          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-5.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/9.png', alt='Ilustración en blanco y negro de una mujer con un vestido de época del siglo XIX. Lleva un vestido amplio con una falda abullonada, detalles decorativos en la parte inferior y mangas cortas con adornos. Sostiene un abanico en una mano y parece llevar un peinado recogido elegante.')
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-10.col-md-9
          figcaption.mb-5 Fuente: SENA
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12
          ...
          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-5.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/10.png', alt='Mujer vistiéndose frente a un biombo, usando un corsé y medias. La escena refleja la intimidad y elegancia de la moda femenina de la época, donde las prendas ajustadas y delicadas eran símbolo de refinamiento y estatus.')
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-10.col-md-9
          figcaption.mb-5 Fuente: SENA
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-right").mb-5
        .col-lg-12
          .bloque-texto-g.color-acento-contenido.p-3.p-lg-5.p-md-4
            .bloque-texto-g__img(
              :style="{'background-image': `url(${require('@/assets/curso/tema1/i3.svg')})`}", alt='Imagen decorativa.'
            )
            .bloque-texto-g__texto.p-lg-5.p-md-4.p-4
      ...
      .row.fondo2.p-4.mb-0(data-aos="fade-down")
        .col-lg-12
          ...
          .row.justify-content-center.align-items-center.mb-lg-4.mb-0(data-aos="fade-left")
            .col-lg-6.col-md-9
              img.img-a.img-t(src='@/assets/curso/tema1/12.png', alt='Sujetadores modernos, confeccionado con tela sencilla y costuras visibles. Su diseño rudimentario refleja la evolución de la lencería femenina hacia prendas más cómodas y funcionales.')
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        .col-lg-10.col-md-9
